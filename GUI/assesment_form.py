...
image = Image.open('C:\\Users\\admin\\Documents\\GitHub\\Villamor_CPE201_PLD01E_PUSH\\GUI\\pictures of microsoft\\wallpaper.jpg')
...
class design_gui_interface():
    def __init__(self, frame1=None):
        self.frame1 = frame1
    def frames(self, x, y):
        self.frame1 = Frame(window, width=100, height=160, border=5,
                            bg='#B0E0E6')
...
uploaded_image = my_gui_design.image_design('C:\\Users\\admin\\Documents\\GitHub\\Villamor_CPE201_PLD01E_PUSH\\GUI\\pictures of microsoft\\wallpaper.jpg', 222, 110, 200, 180)
