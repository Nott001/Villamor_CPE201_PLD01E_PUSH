...
#different buttons
search_button = gui_design.button_design(767, 393, 10, 1, '#EE1E1E', 'SEARCH')
gross_income_button = gui_design.button_design(992, 930, 13, 1, '#0085F1', 'GROSS INCOME')
net_income_button = gui_design.button_design(1093, 930, 13, 1, '#0085F1', 'NET INCOME')
save_button = gui_design.button_design(1194, 930, 7, 1, '#1C8E81', 'SAVE')
update_button = gui_design.button_design(1253, 930, 7, 1, '#1C8E81', 'UPDATE')
next_button = gui_design.button_design(1311, 930, 7, 1, '#D7B600', 'NEW')

#insert of image
employee_image = gui_design.image_design('C:\\Users\\karlr\\OneDrive\\Documents\\GitHub\\Villamor_CPE201_PLD01E_PUSH\\GUI_lab\\pictures of microsoft\\profile.png', 585, 160, 200, 180)
